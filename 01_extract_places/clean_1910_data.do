...
capture log close
clear
log using $logs/clean_1910_data.log, text replace
...
quietly infix                               ///
  ...
  using "/disk/data3/census-ipums/v2019/dat/us1910m_usa.dat" if rectypep=="P" 
...
quietly infix                          ///
  ...
  str 	  US1910M_0016		   2538-2538 ///
  str 	  US1910M_0019		   2546-2547 ///
  str 	  US1910M_0024		   2558-2561 ///
  str 	  US1910M_0025		   2562-2564 ///
  str 	  US1910M_0028		   2577-2590 ///
  str 	  US1910M_0030		   2595-2621 ///
  str 	  US1910M_0033		   2627-2630 ///
  str 	  US1910M_0036		   2636-2638 ///
  str 	  US1910M_0043		   2758-2760 ///
  str 	  US1910M_0046		   2764-2798 ///
  str 	  US1910M_0048		   2800-2817 ///
  str 	  US1910M_0051		   2830-2967 ///
  str 	  US1910M_0052		   2968-3007 ///
  str 	  US1910M_0053		   3008-3077 ///
  str 	  US1910M_0055		   3086-3088 ///
  str 	  US1910M_0059		   3109-3123  ///   
  str 	  US1910M_0062		   3184-3233 ///
  str 	  US1910M_0063		   3234-3313 ///
  using "/disk/data3/census-ipums/v2019/dat/us1910m_usa.dat" if rectype=="H" 
...
save $bulk_path/raw_1910_data.dta, replace
...
keep if temp==1
di _N
save $bulk_path/raw_1910_data_100krows.dta, replace

restore

gen numobs=1

collapse (sum) numobs, by(stateicp statefip stcounty stdcity US1910M_0052 US1910M_0053 US1910M_0063 enumdist)

gen long indexcollapse=_n
save $bulk_path/placecounts_1910.dta, replace
