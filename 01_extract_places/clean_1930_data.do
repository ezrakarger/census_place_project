...
capture log close
clear
log using $logs/clean_1930_data.log, text replace
...
quietly infix                               ///
  ...
  using "/disk/data3/census-ipums/v2019/dat/us1930d_usa.dat" if rectypep=="P" 
...
quietly infix                          ///
  ...
  using "/disk/data3/census-ipums/v2019/dat/us1930d_usa.dat" if rectype=="H" 
...
save $bulk_path/raw_1930_data.dta, replace
...
keep if temp==1
di _N
save $bulk_path/raw_1930_data_100krows.dta, replace

restore

gen numobs=1

collapse (sum) numobs, by(stateicp statefip stcounty stdmcd stdcity enumdist)

gen long indexcollapse=_n
save $bulk_path/placecounts_1930.dta, replace
