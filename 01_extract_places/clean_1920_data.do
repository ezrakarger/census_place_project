...
capture log close
clear
log using $logs/clean_1920_data.log, text replace
...
quietly infix                               ///
  ...
  using "/disk/data3/census-ipums/v2019/dat/us1920c_usa.dat" if rectypep=="P" 
...
quietly infix                          ///
  ...
  str 	  US1920C_0024         2558-2561  ///
  str 	  US1920C_0025         2562-2564  ///
  str 	  US1920C_0037         2627-2630  ///
  str 	  US1920C_0039         2632-2635  ///
  str 	  US1920C_0057         2968-3007  ///
  str     US1920C_0058         3008-3077  ///
  str     US1920C_0068         3187-3236  ///
  str     US1920C_0069         3237-3316  ///
  using "/disk/data3/census-ipums/v2019/dat/us1920c_usa.dat" if rectype=="H" 
...
save $bulk_path/raw_1920_data.dta, replace
...
keep if temp==1
di _N
save $bulk_path/raw_1920_data_100krows.dta, replace

restore

gen numobs=1

collapse (sum) numobs, by(stateicp statefip stcounty stdmcd stdcity US1920C_0057 US1920C_0058 US1920C_0068 US1920C_0069 enumdist)

gen long indexcollapse=_n
save $bulk_path/placecounts_1920.dta, replace
